export default async function handler(req, res) {
  ...
  const session = {
    ...
    audio: {
      ...
      output: { voice: process.env.OPENAI_VOICE || "cedar", speed: 1.03 }
    }
  };
